...
class SpectrogramDecoder(nn.Module):
    ...
    Mirrors the encoder: upsamples the frequency axis by freq_stride at
    each level and adds the corresponding encoder skip connection after each
    upsample step (additive).
    ...
    def __init__(
        ...
        for i, in_ch in enumerate(ch_reversed):
            ...
            self.blocks.append(DecoderBlock(in_ch, next_ch, freq_stride, last=is_last))
